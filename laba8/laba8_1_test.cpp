...
{
//	TYPE1 arg = 0.0;
	TYPE1 divA = 0.0;/////////////////////error
	TYPE1 divB = 0.0;/////////////////////error
	for (int i = 1; i < N; i++)
	{
		divA += A[i] * A[i];/////////////////////error
		divB += B[i] * B[i]; /////////////////////error
	}
	cout<<"skalar(A,B): "<<skalar(A,B)<<endl;
	cout<<"sqrt(divA * divB): "<<sqrt(divA * divB)<<endl;
	cout<<"cos alpha: "<<skalar(A,B) / sqrt(divA * divB)<<endl; /////////////////////error
...
void HouseHolder()
{
	...
	TYPE1 ro = sqrt(2 * alpha * alpha + 2 * alpha * skalar(S,I));
	cout<<"alpha: "<<alpha<<" ro: "<<ro<<endl;
	cout<<" (S,I): "<<skalar(S,I)<<endl;
	cout<<"angle: "<<argVec(S,I)<<endl;
